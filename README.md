...
- Support for Windows via MINGW and MSVC compilers. Original Hobbes was available for Linux and Mac OS, and those OSes are also supported.

Roadmap:
- Support for Windows via Clang compiler